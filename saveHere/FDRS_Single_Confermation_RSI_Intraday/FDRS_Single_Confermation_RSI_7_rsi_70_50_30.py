...
class FDRS_Single_Confermation_RSI_7(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_Single_Confermation_RSI_7_rsi_70_50_30":
    ...
    def backtest(self, stockName, startDate, endDate):
        ...
        try:
            df = getFnoBacktestData(stockName, startTimeEpoch-(86400*300), endTimeEpoch, "3Min")
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_Single_Confermation_RSI_7_rsi_70_50_30"
    version = "v1"
