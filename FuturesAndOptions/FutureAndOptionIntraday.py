        ...
        for timeData in df.index:
            ...
            if not self.openPnl.empty:
                for index, row in self.openPnl.iterrows():
                    ...
                    elif self.timeData >= row["Expiry"] and self.humanTime.time() > time(15, 15):
                        exitType = "ExpiryExit"
            ...
            if ((timeData-900) in df_15Min.index) and self.openPnl.empty:
                ...
                if (self.humanTime.time() < time(15, 15)) and (self.humanTime.time() >= time(9, 16)):
                    if (df_15Min.at[lastdf15MinIndexTimeData[1], "longEntry"] == "longEntry"):
                    ...
                    elif (df_15Min.at[lastdf15MinIndexTimeData[1], "longExit"] == "longExit"):
