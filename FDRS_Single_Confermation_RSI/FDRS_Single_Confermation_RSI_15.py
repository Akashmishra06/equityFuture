...
class FDRS_Single_Confermation_RSI_15(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_Single_Confermation_RSI_15":
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_Single_Confermation_RSI_15"
    version = "v1"
    ...
    algoLogicObj = FDRS_Single_Confermation_RSI_15(devName, strategyName, version)
