...
class FDRS_Single_Confermation_RSI_10(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_Single_Confermation_RSI_10":
    ...
    def backtest(self, stockName, startDate, endDate):
        ...
        df['rsi'] = talib.RSI(df['c'], timeperiod=10)
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_Single_Confermation_RSI_10"
    version = "v1"
    ...
    algoLogicObj = FDRS_Single_Confermation_RSI_10(devName, strategyName, version)
