...
class FDRS_Single_Confermation_RSI_7(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_Single_Confermation_RSI_7_80_20":
    ...
    def backtest(self, stockName, startDate, endDate):
        ...
        df['longEntry'] = np.where((df['rsi'] > 80), "longEntry", "")
        df['longExit'] = np.where((df['rsi'] < 20), "longExit", "")
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_Single_Confermation_RSI_7_80_20"
    version = "v1"
