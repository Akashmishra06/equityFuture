...
class FDRS_Single_Confermation_RSI_7_Candle_Colour(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_Single_Confermation_RSI_7_Candle_Colour":
    ...
    def backtest(self, stockName, startDate, endDate):
        ...
        # lotSize = int(getExpiryData(1758876300, stockName)["LotSize"])
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_Single_Confermation_RSI_7_Candle_Colour"
    version = "v1"
    ...
    algoLogicObj = FDRS_Single_Confermation_RSI_7_Candle_Colour(devName, strategyName, version)
