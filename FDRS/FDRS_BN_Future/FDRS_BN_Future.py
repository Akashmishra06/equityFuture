...
class FDRS_BN_Future(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_BN_Future":
...
if __name__ == "__main__":
    ...
    algoLogicObj = FDRS_BN_Future(devName, strategyName, version)
