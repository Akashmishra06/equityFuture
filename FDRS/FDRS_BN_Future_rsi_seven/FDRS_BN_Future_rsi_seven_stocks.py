...
class FDRS_BN_Future_rsi_seven_stocks(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "FDRS_BN_Future_rsi_seven_stocks":
    ...
    def backtest(self, stockName, startDate, endDate):
        ...
        try:
            df = getEquityBacktestData(stockName, startTimeEpoch-(86400*300), endTimeEpoch, "1H")
...
if __name__ == "__main__":
    ...
    devName = "NA"
    strategyName = "FDRS_BN_Future_rsi_seven_stocks"
    version = "v1"

    startDate = datetime(2020, 4, 1, 9, 15)
    endDate = datetime(2025, 9, 30, 15, 30)

    portfolio = createPortfolio("/root/development/equityFuture/stocksList/nifty50.md", 5)

    algoLogicObj = FDRS_BN_Future_rsi_seven_stocks(devName, strategyName, version)
